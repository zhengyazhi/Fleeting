...
public class unfinishscheduleActivity extends AppCompatActivity implements RecyclerViewAdapter.onSlidingViewClickListener {

    private RecyclerView mRecyclerView;
    public final int WRITEDNEWDIART = 5;
    private List<schedule> schedules=new ArrayList<>();
    private RecyclerViewAdapter recyclerViewAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unfinishschedule);
        mRecyclerView=findViewById(R.id.recyclerview_unfinish);
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent=new Intent(unfinishscheduleActivity.this, SechdueDetailActivity.class);
    ...
    public void datas(){
        ...
        schedules= dbcontrol.unfinishse(today);
    }
